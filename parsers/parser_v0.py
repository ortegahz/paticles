...
def parse_args():
    ...
    parser.add_argument('--path_in', default='/media/manu/data/docs/particles/MPY22GN2D0012490P_20240205_114045.xls')
    ...
    parser.add_argument('--times_pick', default=[('11:41', 'start', 'y'), ('11:41', 'alarm', 'b')])
