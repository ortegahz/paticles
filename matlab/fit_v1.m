...
%%
temp = 20; humid = 20;
X1 = [0, 792, 1095, 1386, 1540, 1639, 1709, 1906, 1921, 2031, 2111, 2189, 2254];
X2 = [0, 716, 986, 1247, 1399, 1485, 1545, 1721, 1731, 1827, 1881, 1934, 1973];
Y = [0, 35, 68, 120, 163, 194, 224, 297, 330, 392, 446, 489, 522];
...
temp = 55; humid = 20;
X1 = [0, 744, 1575, 1867, 1989, 2123, 2104, 2142, 2208, 2311, 2355, 2474, 2548, 2651, 2752, 2913];
X2 = [0, 868, 1358, 1630, 1747, 1874, 1856, 1891, 1949, 2045, 2085, 2202, 2269, 2341, 2428, 2540];
Y = [0, 20, 72, 117, 150, 189, 198, 213, 235, 271, 293, 337, 380, 418, 459, 507];
fit_sensor(X1, X2, Y, temp, humid);

temp = 55; humid = 60;
X1 = [0, 688, 1325, 1927, 2138, 2347, 2359, 2403, 2431, 2544, 2671, 2703, 2827, 2923, 3022, 3133];
X2 = [0, 573, 1253, 1637, 1869, 2062, 2067, 2114, 2148, 2253, 2378, 2419, 2526, 2623, 2703, 2779];
Y = [0, 4, 47, 82, 124, 173, 183, 199, 215, 248, 294, 323, 381, 426, 464, 503];
fit_sensor(X1, X2, Y, temp, humid);

temp = 55; humid = 90;
X1 = [0, 638, 1986, 2368, 2523, 2546, 2574, 2646, 2775, 2867, 2920, 2978, 3041, 3141, 3263];
X2 = [0, 584, 1784, 2132, 2275, 2208, 2302, 2369, 2495, 2581, 2635, 2678, 2728, 2805, 2895];
Y = [0, 0, 61, 104, 146, 163, 181, 207, 259, 315, 355, 392, 425, 461, 504];
fit_sensor(X1, X2, Y, temp, humid);
